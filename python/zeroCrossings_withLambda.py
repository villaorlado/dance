...
for y in range(0, sh.ncols):
	...
	#zeroCrossings1 = (np.diff(np.sign(joint_list)) != 0).sum()	
	zeroCrossings = len(list(itertools.groupby(joint_list, lambda joint_list: joint_list > 0)))
	#zeroCrossings = zeroCrossings2 - zeroCrossings1
