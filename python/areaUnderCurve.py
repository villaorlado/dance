...
import xlrd
'''
I will use the matrix form the excel file to calculate the Area Under the Curve for each measurement, for each character
'''
...
workbook = xlsxwriter.Workbook('../data/RMSdiff_' + toRemove + '.xlsx')
worksheet = workbook.add_worksheet()

mDict = {"luruh":{},"lanyap":{},"gagah":{},"raksasa":{},"wanara":{},"jatayu":{}}

types = "gagah,luruh,lanyap,raksasa,wanara,jatayu".split(",")
nonJatayu = "gagah,luruh,lanyap,raksasa,wanara,jatayu".split(",")
nonJatayu.remove(toRemove)
...
for n in nonJatayu:
	for m in measurements:
		for d in xyz:
			...
			jatayu_values = mDict[toRemove][m][d]
